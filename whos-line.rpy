...
screen whos_line_game_end_screen():
  tag menu
  add "BGs/nightskysepia.png"
  textbutton "Line 1 Replay" action Replay(Lines[0].replay)
...
label whos_line_game_start:
  ...
  "Game Rules: Drag the text to the character who said it."
...
# Game Setup #
define Lines = [
    Line("ayane1","I feel like it was just yesterday you were poking my arms and calling them squishy. Now, I could probably beat you to death blindfolded!", "firsttimedojo", "ayane_destination", False, False),
    Line("ayane2","I feel like you could convince me to do literally anything by just telling me you love me over and over. Hearts are annoying. Stop taking advantage of my biggest weakness.", "ayanebonus1", "ayane_destination", False, False),
    Line("sana1", "When I...look at the egg, I...I see an egg...", "sportswars3", "sana_destination", False, False),
    Line("sana2", "Sensei, you...don't love me. But I'm flattered you...felt good enough to maybe think you did for a second", "sanainvite2", "sana_destination", False, False),
    Line("ami1", "Is sensory deprivation cruel? Or is that kind of just a thing that nobody really cares about?", "beachmas8", "ami_destination", False, False),
    Line("ami2", "You haven't spent as much time with me here as you have with her yet, but I'm like a walking trash receptacle for your love!", "amimaid30", "ami_destination", False, False),
    Line("maya1", "Never leave me. Ever. Ever. Ever. Ever. Ever. Ever. Ever. And I promise you — I will do the same.", "halloweenmaya2", "maya_destination", False, False),
    Line("maya2", "You can passively help, though. By just being around and not doing anything stupid. And occasionally buying me exorbitant amounts of food and allowing me to walk with you in my yukata.", "maya_destination", "mayafestival3", False, False)
]
